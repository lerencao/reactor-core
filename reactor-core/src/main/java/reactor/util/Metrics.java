...
public class Metrics {
	 ...
	 */
	public static BiFunction<Tuple2<String, String>, ScheduledExecutorService, ScheduledExecutorService> instrumentedExecutorService() {
	...
	static final class MicrometerSchedulersDecorator
			implements BiFunction<Tuple2<String, String>, ScheduledExecutorService, ScheduledExecutorService> {

		private Map<String, Long> seenSchedulers = new HashMap<>();

		@Override
		public ScheduledExecutorService apply(Tuple2<String, String> schedulerTypeAndDescription,
				ScheduledExecutorService service) {
			String schedulerType = schedulerTypeAndDescription.getT1();
			String schedulerDescription = schedulerTypeAndDescription.getT2();
